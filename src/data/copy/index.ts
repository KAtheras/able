  ...
  en: {
    ...
    taxBenefits: {
      ...
      chartDescription:
        ...
        totalLabel: "Total Tax Benefits",
        totalCaption: "Total tax benefits",
      },
    },
    labels: {
    ...
    misc: {
      ...
      accountActivityInformation: "Account Activity Information",
      budgetQualifiedHeader: "BUDGET FOR QUALIFIED DISABILITY EXPENSES",
      horizonMaxLabel: "Max",
      horizonYearSuffix: "Y",
  ...
  es: {
    ...
    report: {
      ...
      taxBenefits: {
        ...
        totalLabel: "Beneficios fiscales totales",
        totalCaption: "Beneficios fiscales totales",
      },
    },
    labels: {
    ...
    misc: {
      ...
      accountActivityInformation: "Información de actividad de la cuenta",
      budgetQualifiedHeader: "PRESUPUESTO PARA GASTOS DE DISCAPACIDAD CALIFICADOS",
      horizonMaxLabel: "Max",
      horizonYearSuffix: "A",
